...
using System.Text;
using EngineLauncher.Reflection;
 ...
 IDictionary<string, object>
    {
        ...
        /// <summary>
        /// Get Value, and return errorValue while the key is invalide
        /// </summary>
        /// <param name="key"></param>
        /// <param name="errorValue"></param>
        /// <returns></returns>
        public object GetValue(string key, object errorValue)
        {
            object value = null;
        ...
        public bool GetBool(string key)
        {
            ...
            if (value != null)
            {
                if (string.Compare(value.ToString(), "true", StringComparison.OrdinalIgnoreCase) == 0)
                {
                    return true;
                }
                else
 ...
 static class SimpleJson
    {
        ...
        [ThreadStatic]
        static StringBuilder serializeObjectStringBuilder;
        /// <summary>
        /// 避免堆内存分配的解析方式
        /// Modify By ZhangMinglin
        /// </summary>
        public static string SerializeObjectInHeap(object json)
        {
            if (serializeObjectStringBuilder == null)
            {
                serializeObjectStringBuilder = new StringBuilder(BUILDER_CAPACITY);
            }
            else
            {
                serializeObjectStringBuilder.Length = 0;
            }
            bool success = SerializeValue(CurrentJsonSerializerStrategy, json, serializeObjectStringBuilder);
            return (success ? serializeObjectStringBuilder.ToString() : null);
        }
