...
public class DragDropManagerEx
{
    ...
    public void StartDrag(GObject source, GComponent dComponent, object sourceData, int touchPointID = -1)
    {
    ...
    private void __dragEnd(EventContext evt)
    {
        ...
        EventDispatcher.GameWorld.DispatchEvent(EventDefine.DRAGDROP_CANCLE, source, sourceData);
    }
}
