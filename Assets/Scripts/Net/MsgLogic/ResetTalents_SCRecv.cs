...
namespace Engine
{
    ...
    public class ResetTalents_SCRecv : IReceiver
    {
        public ResetTalents_SC msg;

        public int MsgID()
        {
            return (int)eMsgID.eMsg_ResetTalents_SC;
        }
        ...
        public void Process()
        {
            if (msg.Result == eErrCode.eErrCode_Success)
            {
                ...
                TalentInfoManager.Instance.GetTalentDict().Clear();
        ...
        {
            msg = ResetTalents_SC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}