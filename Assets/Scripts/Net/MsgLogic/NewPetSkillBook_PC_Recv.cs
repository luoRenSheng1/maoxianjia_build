...
namespace Engine
{
    ...
    public class NewPetSkillBook_PC_Recv : IReceiver
    {
        public NewPetSkillBook_PC msg;
        
        public int MsgID()
        {
            return (int)eMsgID.eMsg_NewPetSkillBook_PC;
        }
        ...
        {
            msg = NewPetSkillBook_PC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}