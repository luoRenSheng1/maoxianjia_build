...
namespace Engine
{
    ...
    public class ClaimDailyTaskAward_SCRecv : IReceiver
    {
        public ClaimDailyTaskAward_SC msg;

        public int MsgID()
        {
            return (int)eMsgID.eMsg_ClaimDailyTaskAward_SC;
        }
        ...
        public void Process()
        {
            ...
            {
                TaskInfoManager.Instance.UpdateDailyTaskInfo((int) msg.TaskId, true, -1);
        ...
        {
            msg = ClaimDailyTaskAward_SC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}
