...
namespace Engine
{
    public class PlayerEquipsInfo4Login_PC_Recv : IReceiver
    {
        public PlayerEquipsInfo4Login_PC msg;
        public int MsgID()
        {
            return (int) eMsgID.eMsg_PlayerEquipsInfo4Login_PC;
        }

        public void Process()
        {
            LogUtils.LogWarningFormat("PlayerEquipsInfo4Login_PC_Recv Process");
        ...
        {
            LogUtils.LogWarning("PlayerEquipsInfo4Login_PC_Recv Read " + mRecv.Length);
            msg = PlayerEquipsInfo4Login_PC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}