...
namespace Engine
{
    ...
    public class ClaimOnlineAward_SCRecv : IReceiver
    {
        public ClaimOnlineAward_SC msg;

        public int MsgID()
        {
            return (int)eMsgID.eMsg_ClaimOnlineAward_SC;
        }
        ...
        public void Process()
        {
            if (msg.Result == eErrCode.eErrCode_Success)
            {
                ...
                DataManager.Instance.mRoleData.OnlineAwardCdTime = msg.OnlineAwardCount;
        ...
        {
            msg = ClaimOnlineAward_SC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}
