...
namespace Engine
{
    ...
    public class SkillLottery_SCRecv : IReceiver
    {
        public SkillLottery_SC msg;

        public int MsgID()
        {
            return (int)eMsgID.eMsg_SkillLottery_SC;
        }
        ...
        public void Process()
        {
            if (msg.Result == eErrCode.eErrCode_Success)
            {
                ...
                AdManager.Instance.SetAdFreeTime((int) ePlayerAttrID.ePlayerAttrID_SkillLottoTimesByAd, msg.FreeAdTimes);
        ...
        {
            msg = SkillLottery_SC.ParseFrom(mRecv.obj);
            return true;
        }
    }
}
