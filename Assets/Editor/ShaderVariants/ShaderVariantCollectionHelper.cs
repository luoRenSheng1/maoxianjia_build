...
namespace ShaderVariantCollector 
{
    ...
    public class ShaderParsedCombinations 
    {
        ...
        public String Dump() 
        {
            ...
            sb.Append(ShaderVariantUtils.DumpShaderPasses( shader ) );
    ...
    public static class ShaderVariantUtils 
    {
        ...
        public static void OpenShaderCombinations( Shader shader, bool usedBySceneOnly, bool withLog = true ) 
        {
            ...
            {
                UnityEngine.Debug.LogErrorFormat( "{0} is precompiled shader.", shader.name );
                return;
            }
            if ( withLog ) 
            {
                UnityEngine.Debug.LogFormat( "OpenShaderCombinations: {0}, usedBySceneOnly = {1}", shader.name, usedBySceneOnly );
            }
        ...
        {
            if ( shader == null || !ShaderVariantUtils.HasCodeSnippets( shader ) ) 
            {
                return null;
            }
            ...
            try {
                ...
                ShaderVariantUtils.OpenShaderCombinations( shader, true, withLog );
                if ( File.Exists( combFilePath ) ) 
                {
        ...
        public static List<String> GetShaderKeywords( Shader shader ) 
        {
            ...
            ShaderVariantUtils.GetShaderVariantEntriesMethod.Invoke( null, args );
