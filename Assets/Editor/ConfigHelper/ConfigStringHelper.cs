...
namespace Google.Protobuf
{
    ...
    {
        private static string s_ClassNameRaw = "string";
        private static string s_ClassName = "ConfigString";
        ...
        public static void doXlsxToBin()
        {
            ...
            if (ExporterUtils.ExportXlsx(strPath, ref listData, ref listDataName, ref listDataType, ref listDataDesc, ref strKeyField, ref keyFieldType))
            {
                ...
                {
                     Debug.LogError("[XlsxToBin]	doXlsxToBin Fail: ConfigString FieldNum NotMatch With Excel, Please Check.");
                     return;
                }
                
                ConfigString data = new ConfigString();
                ...
                for (int nIndex = 3; nIndex < listData.Count; ++nIndex)
                {
                    ...
                    ConfigStringUnit unit = new ConfigStringUnit();
                    ...
                    {
                        Debug.LogError("[XlsxToBin] doXlsxToBin Error: ConfigString Repeat Key, Please Check. " + unit.Id);
                    }
                    
                    data.Data[unit.Id] = unit;
                }
                
                EngineBase.ConfigSerializer.Serialize<ConfigString>(data, strPathOut);
