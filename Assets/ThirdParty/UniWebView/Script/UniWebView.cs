...
public class UniWebView: MonoBehaviour {
    ...
    private Vector4 frameVector4;

    public Vector4 FrameVector4
    {
        get {
            frameVector4.Set(frame.x, frame.y, frame.width, frame.height);
            return frameVector4;
        }
        set
        {
            Rect f = new Rect(value.x, value.y, value.z, value.w);
            Frame = f;
        }
    }
