...
WX_SDKRYINIT:function(p1, p2, p3){
	window.WXWASMSDK.WX_SDKRYINIT(_WXPointer_stringify_adaptor(p1), _WXPointer_stringify_adaptor(p2), _WXPointer_stringify_adaptor(p3));
},
WX_SDKRYREGISTER:function(p1, p2){
	window.WXWASMSDK.WX_SDKRYREGISTER(_WXPointer_stringify_adaptor(p1), _WXPointer_stringify_adaptor(p2));
},
WX_SDKRYLOGGEDIN:function(p1, p2){
	window.WXWASMSDK.WX_SDKRYLOGGEDIN(_WXPointer_stringify_adaptor(p1), _WXPointer_stringify_adaptor(p2));
},
WX_SDKRYPAYMENT:function(p1, p2, p3, p4, p5){
	window.WXWASMSDK.WX_SDKRYPAYMENT(_WXPointer_stringify_adaptor(p1), p2, _WXPointer_stringify_adaptor(p3), _WXPointer_stringify_adaptor(p4), _WXPointer_stringify_adaptor(p5));
},
WX_SDKRYEVENT:function(p1, p2){
	window.WXWASMSDK.WX_SDKRYEVENT(_WXPointer_stringify_adaptor(p1), _WXPointer_stringify_adaptor(p2));
},
WX_ShareImageToGameCenter:function(conf, callbackId) {
	window.WXWASMSDK.WX_ShareImageToGameCenter(_WXPointer_stringify_adaptor(conf), _WXPointer_stringify_adaptor(callbackId));
},
WX_ShareCanvasToGameCenter:function(conf, callbackId){
	window.WXWASMSDK.WX_ShareCanvasToGameCenter(_WXPointer_stringify_adaptor(conf), _WXPointer_stringify_adaptor(callbackId));
}   
})